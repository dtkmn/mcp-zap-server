...
title: "JWT Setup"
editUrl: false
description: "The MCP ZAP Server supports JWT (JSON Web Token) authentication for enhanced security and token-based access control. This provides a modern, stateless authentication"
---
## Overview
...
- [JWT Key Rotation Runbook](jwt-key-rotation-runbook/) - Planned and emergency rotation steps
