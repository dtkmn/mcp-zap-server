...
@SpringBootTest(
        ...
        properties = {
                ...
                "mcp.server.protection.backpressure.max-direct-scans=1"
        }
)
@ActiveProfiles("test")
@Import(AbstractMcpProtectionIntegrationTest.MockZapConfig.class)
class McpDirectBackpressureIntegrationTest extends AbstractMcpProtectionIntegrationTest {

    @Test
    void directAdmissionIsRejectedWhenGlobalDirectCapacityIsExhausted() throws Exception {
        ...
        assertThat(second.getResponseBody()).contains("direct_scan_capacity");
    }
}
